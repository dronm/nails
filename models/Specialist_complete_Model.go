...
type Specialist_complete_argv struct {
	Argv *Specialist_complete `json:"argv"`	
}

//Exported model metadata
var Specialist_complete_md fields.FieldCollection

func Specialist_complete_Model_init() {	
	Specialist_complete_md = fields.GenModelMD(reflect.ValueOf(Specialist_complete{}))
}

//
type Specialist_complete struct {
