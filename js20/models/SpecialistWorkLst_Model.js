...
function SpecialistWorkLst_Model(options){
	var id = 'SpecialistWorkLst_Model';
	options = options || {};
	...
	options.fields.photo = new FieldJSON("photo",filed_options);
	
		SpecialistWorkLst_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistWorkLst_Model,ModelXML);
