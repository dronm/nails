...
function SpecialistWork_Model(options){
	var id = 'SpecialistWork_Model';
	options = options || {};
	...
	options.fields.admin_rate = new FieldInt("admin_rate",filed_options);
	...
	options.fields.ycl_document_id = new FieldInt("ycl_document_id",filed_options);
		...
		SpecialistWork_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistWork_Model,ModelXML);
