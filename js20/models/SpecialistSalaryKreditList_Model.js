...
function SpecialistSalaryKreditList_Model(options){
	var id = 'SpecialistSalaryKreditList_Model';
	options = options || {};
	...
	options.fields.salary_kredits_ref = new FieldJSON("salary_kredits_ref",filed_options);
	...
	options.fields.total.getValidator().setMaxLength('15');
		...
		SpecialistSalaryKreditList_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistSalaryKreditList_Model,ModelXML);
