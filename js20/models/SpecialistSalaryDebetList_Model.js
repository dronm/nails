...
function SpecialistSalaryDebetList_Model(options){
	var id = 'SpecialistSalaryDebetList_Model';
	options = options || {};
	...
	options.fields.salary_debets_ref = new FieldJSON("salary_debets_ref",filed_options);
	...
	options.fields.total.getValidator().setMaxLength('15');
		...
		SpecialistSalaryDebetList_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistSalaryDebetList_Model,ModelXML);
