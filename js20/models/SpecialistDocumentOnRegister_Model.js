...
function SpecialistDocumentOnRegister_Model(options){
	var id = 'SpecialistDocumentOnRegister_Model';
	options = options || {};
	...
	options.fields.need_signing = new FieldBool("need_signing",filed_options);
		...
		SpecialistDocumentOnRegister_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistDocumentOnRegister_Model,ModelXML);
