...
function SpecialistRegDialog_Model(options){
	var id = 'SpecialistRegDialog_Model';
	options = options || {};
	...
	options.fields.address_reg = new FieldString("address_reg",filed_options);
	...
	options.fields.passport = new FieldJSONB("passport",filed_options);
	...
	options.fields.operation_result = new FieldBool("operation_result",filed_options);
	
		SpecialistRegDialog_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistRegDialog_Model,ModelXML);
