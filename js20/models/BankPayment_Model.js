...
function BankPayment_Model(options){
	var id = 'BankPayment_Model';
	options = options || {};
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Наименование плательщика';
	filed_options.autoInc = false;	
	
	options.fields.payer = new FieldText("payer",filed_options);
	...
	options.fields.payer_acc.getValidator().setMaxLength('20');
	
				
	
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'ИНН получателя';
	filed_options.autoInc = false;	
	
	options.fields.payer_inn = new FieldString("payer_inn",filed_options);
	options.fields.payer_inn.getValidator().setMaxLength('12');
	...
	options.fields.payer_bank_acc.getValidator().setMaxLength('20');
	...
	options.fields.payer_bank_bik.getValidator().setMaxLength('9');
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Наименование получателя';
	filed_options.autoInc = false;	
	
	options.fields.rec = new FieldText("rec",filed_options);
	...
	options.fields.rec_inn = new FieldString("rec_inn",filed_options);
	options.fields.rec_inn.getValidator().setMaxLength('12');
	...
	options.fields.rec_acc.getValidator().setMaxLength('20');
	...
	options.fields.rec_bank_acc.getValidator().setMaxLength('20');
	...
	options.fields.rec_bank_bik.getValidator().setMaxLength('9');
	...
	options.fields.specialist_period_salary_detail_id.getValidator().setRequired(true);
		...
		BankPayment_Model.superclass.constructor.call(this,id,options);
}
extend(BankPayment_Model,ModelXML);
