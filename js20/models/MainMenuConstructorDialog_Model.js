...
function MainMenuConstructorDialog_Model(options){
	var id = 'MainMenuConstructorDialog_Model';
	options = options || {};
	...
	options.fields.content = new FieldText("content",filed_options);
		...
		MainMenuConstructorDialog_Model.superclass.constructor.call(this,id,options);
}
