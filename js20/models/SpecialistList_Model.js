...
function SpecialistList_Model(options){
	var id = 'SpecialistList_Model';
	options = options || {};
	...
	options.fields.specialities_ref = new FieldJSON("specialities_ref",filed_options);
		...
		SpecialistList_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistList_Model,ModelXML);
