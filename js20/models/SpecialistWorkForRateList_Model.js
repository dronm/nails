...
function SpecialistWorkForRateList_Model(options){
	var id = 'SpecialistWorkForRateList_Model';
	options = options || {};
	...
	options.fields.admin_rate = new FieldInt("admin_rate",filed_options);
		...
		SpecialistWorkForRateList_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistWorkForRateList_Model,ModelXML);
