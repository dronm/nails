...
function SpecialistDocumentList_Model(options){
	var id = 'SpecialistDocumentList_Model';
	options = options || {};
	...
	options.fields.document_att_ref = new FieldJSON("document_att_ref",filed_options);
	...
	options.fields.signed = new FieldBool("signed",filed_options);
	...
	options.fields.opened = new FieldBool("opened",filed_options);
	...
	options.fields.name = new FieldText("name",filed_options);
		...
		SpecialistDocumentList_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistDocumentList_Model,ModelXML);
