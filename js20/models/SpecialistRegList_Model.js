...
function SpecialistRegList_Model(options){
	var id = 'SpecialistRegList_Model';
	options = options || {};
	...
	options.fields.operation_result = new FieldBool("operation_result",filed_options);
		...
		SpecialistRegList_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistRegList_Model,ModelXML);
