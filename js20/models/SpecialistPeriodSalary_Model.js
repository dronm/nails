...
function SpecialistPeriodSalary_Model(options){
	var id = 'SpecialistPeriodSalary_Model';
	options = options || {};
	...
	options.fields.period.getValidator().setRequired(true);
	...
	options.fields.studio_id.getValidator().setRequired(true);
		...
		SpecialistPeriodSalary_Model.superclass.constructor.call(this,id,options);
}
extend(SpecialistPeriodSalary_Model,ModelXML);
