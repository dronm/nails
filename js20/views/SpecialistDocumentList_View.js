 ...
 */
function SpecialistDocumentList_View(id,options){	

	options.HEAD_TITLE = "Документы";
	SpecialistDocumentList_View.superclass.constructor.call(this,id,options);

	var model = (options.models && options.models.SpecialistDocumentList_Model)? options.models.SpecialistDocumentList_Model : new SpecialistDocumentList_Model();
	...
	this.addElement(new GridAjx(id+":grid",{
		...
		//TODO подсветка непросмотренных, неподписанных		
			...
			"elements":[
				new GridRow(id+":grid:head:operation_result",{
					"elements":[
						...
						,new GridCellHead(id+":grid:head:sign_date_time",{
							"value":"Подписан",
							"columns":[
								new GridColumnDate({
									"field":model.getField("sign_date_time")
								})
							],
							"sortable":true
						})						
						,is_specialist? null : new GridCellHead(id+":grid:head:open_date_time",{
							"value":"Просмотрен",
							"columns":[
								new GridColumnDate({
									"field":model.getField("open_date_time")
								})
							],
							"sortable":true
						})						
...
extend(SpecialistDocumentList_View,ViewAjxList);
