-- Function: document_templates_rent_contract(in_specialist_id int)

-- DROP FUNCTION document_templates_rent_contract(in_specialist_id int);

CREATE OR REPLACE FUNCTION document_templates_rent_contract(in_specialist_id int)
  RETURNS jsonb AS
$$
	WITH
	contr_date AS
...
$$
  ...
  COST 100;
ALTER FUNCTION document_templates_rent_contract(in_specialist_id int) OWNER TO ;
